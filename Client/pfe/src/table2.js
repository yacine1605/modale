						...
						<tbody>
							<tr>
								...
								<td className="tg-73oq">
									<Input name="Production" placeholder="enter a number" />
								</td>
								<td className="tg-f8tv">
									<Input name="debarquemeent_min" placeholder="enter a number" />
								</td>
								<td className="tg-0pky">
									{' '}
									<Input name="debarquemeent_moy" placeholder="enter a number" />
								</td>
								<td className="tg-0pky">
									{' '}
									<Input name="debarquemeent_max" placeholder="enter a number" />
								</td>
								<td className="tg-0pky">
									<Input name="consommation_min" placeholder="enter a number" />
								</td>
								<td className="tg-0pky">
									{' '}
									<Input name="consommation_moy" placeholder="enter a number" />
								</td>
								<td className="tg-0pky">
									<Input name="consommation_max" placeholder="enter a number" />
								</td>
